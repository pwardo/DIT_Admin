...
if ($myACL->hasPermission('access_admin') != true)
{
	...
	mysql_query("UPDATE staff SET staff.first_name = '$changeTo' WHERE staff_id = ".$staff_data['staff_id']) or die("display_db_query:" . mysql_error());
            header("Location: reg_lecturer2.php?staff_id=$staff_id");
    }
    ...
    {
        $changeTo = mysql_real_escape_string($changeTo);
	mysql_query("UPDATE Registrations SET Registrations.Courses_code = '$changeTo' WHERE Registrations.staff_staff_id = ".$staff_data['staff_id']) or die("display_db_query:" . mysql_error());
            header("Location: reg_lecturer2.php?staff_id=$staff_id");
    }
    ...
    {
        $changeTo = mysql_real_escape_string($changeTo);
	mysql_query("UPDATE staff SET Students.address_line4 = '$changeTo' WHERE staff_id = ".$staff_data['staff_id']) or die("display_db_query:" . mysql_error());
            header("Location: reg_lecturer2.php?staff_id=$staff_id");
    }    
