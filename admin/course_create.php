        ...
        <table class="Table">			
            <form action="" method='POST'>
                <tr> <!-- change last name -->
                    ...
                    <td></td>
                    <td><input type='text' name='createCourseCode'></td><td><b>Example: DT249</b></td>
                </tr>
        
                <tr> <!-- change last name -->
                    <td><span class="Bold">Course Title: </span></td>
                    <td></td>
                    <td><input type='text' name='createCourseTitle'></td><td><b>Example: Computer Science</b></td>
                </tr>
                <tr>
                    <td colspan="3"><input type='submit' value='Create New Course'></td>
                </tr>                
            </form>
